...
start = st.date_input('Select a start date for the range', value=pd.to_datetime('2020-01-01'))
stop = st.date_input('Select a stop date for the range', value=pd.to_datetime('2020-01-10'))
